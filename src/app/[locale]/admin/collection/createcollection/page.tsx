<<<<<<< HEAD:src/app/admin/collection/createcollection/page.tsx
'use client';
...
export default CreateCollection;
>>>>>>> 8715b16 (big update, adding localization, switch between english and vietnamese, bugs: top nav links smooth scroll in mobile screen didn't trigger smooth scroll from gsap, may fix later):src/app/[locale]/admin/collection/createcollection/page.tsx
