<<<<<<< HEAD:src/app/admin/mintnft/page.tsx
'use client';
...
export default Experience;
>>>>>>> 8715b16 (big update, adding localization, switch between english and vietnamese, bugs: top nav links smooth scroll in mobile screen didn't trigger smooth scroll from gsap, may fix later):src/app/[locale]/admin/mintnft/page.tsx
