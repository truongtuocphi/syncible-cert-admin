...
<table className="table-fixed border-separate border-spacing-0 overflow-hidden text-xs xs:text-base">
  <thead className="border h-[88px] bg-white/50 rounded-t-[1.25rem]">
    <tr>
      <th className="border border-r-0 rounded-tl-[1.25rem]">Features</th>
      <th className="border border-r-0">Tokenized Credentials</th>
      <th className="border border-r-0">Paper Credentials</th>
      <th className="border rounded-tr-[1.25rem]">PDF Credentials</th>
    </tr>
  </thead>
  <tbody className="text-[#6C6D71]">
    <tr className="h-[108px]">
      <td className="border border-t-0 border-r-0 p-2">Verification</td>
      <td className="border border-t-0 border-r-0 p-2">Instant blockchain-based Manual verification</td>
      <td className="border border-t-0 border-r-0 p-2">Manual verification, slow process</td>
      <td className="border border-t-0 p-2">Manual or semi-automated verification</td>
    </tr>
    <tr className="h-[108px]">
      <td className="border border-t-0 border-r-0 p-2">Fraud Protection</td>
      <td className="border border-t-0 border-r-0 p-2">Instant blockchain-based Manual verification</td>
      <td className="border border-t-0 border-r-0 p-2">Low - Susceptible to forgery and tampering</td>
      <td className="border border-t-0 border-r-0 p-2">Manual or semi-automated verification</td>
    </tr>
    <tr className="h-[108px]">
      <td className="border border-t-0 border-r-0 p-2">Shareability</td>
      <td className="border border-t-0 border-r-0 p-2">Cannot be lost or damaged as they are stored digitally on blockchain</td>
      <td className="border border-t-0 border-r-0 p-2">High risk of loss or damage</td>
      <td className="border border-t-0 p-2">Vulnerable to loss or corruption if storage device fails</td>
    </tr>
    <tr className="h-[108px]">
      <td className="border border-t-0 border-r-0 p-2">Cost</td>
      <td className="border border-t-0 border-r-0 p-2">Initial setup cost but lower long-term costs</td>
      <td className="border border-t-0 border-r-0 p-2">Higher costs for printing, storage, and replacement</td>
      <td className="border border-t-0  p-2">Low cost, easily generated and distributed</td>
    </tr>
    <tr className="h-[108px]">
      <td className="border border-t-0 border-r-0 rounded-bl-[1.25rem] p-2">Access</td>
      <td className="border border-t-0 border-r-0 p-2">24/7 access from any internet-enabled device</td>
      <td className="border border-t-0 border-r-0 p-2">Physical access only, can be hard to retrive remotely</td>
      <td className="border border-t-0 rounded-br-[1.25rem] p-2">Accessible from any device with the proper software</td>
    </tr>
  </tbody>
</table>
