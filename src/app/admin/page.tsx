...
const listCard = [
  ...
  // },
  {
    ...
    icon: <MdOutlineDashboardCustomize className="text-2xl text-gray-600" />,
  ...
  },
  {
    ...
    icon: <MdCollectionsBookmark className="text-2xl text-gray-600" />,
  ...
  },
  {
    ...
    icon: <GiDiploma className="text-2xl text-gray-600" />,
