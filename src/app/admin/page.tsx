...
const listCard = [
  ...
  // },
  {
    ...
    icon: <MdOutlineDashboardCustomize className="text-2xl text-primary" />,
  ...
  },
  {
    ...
    icon: <MdCollectionsBookmark className="text-2xl text-primary" />,
  ...
  },
  {
    ...
    icon: <GiDiploma className="text-2xl text-primary" />,
