...
// 2. Fetch posts with pagination and optional category filter
...
export const fetchPostBySlug = async (slug: string) => {
  const url = `${WP_BASE_URL}/posts?slug=${slug}`;
  try {
...
// 4. Fetch media (featured image or media by ID)
